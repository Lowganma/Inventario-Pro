...
/**
 * Banner con cuadrícula animada y blob difuminado.
 * El contenedor raíz es un `group` para que Tailwind habilite
...
const Container = styled.div`
  ...
  &:hover {
    .cuadros {
      transform: rotate(37deg) rotateX(5deg) rotateY(12deg) skew(2deg, 1deg)
        scale(1.2);
    }
    .contentsvg {
      bottom: -100px;
